...
const InviteAdminrouter = express.Router();
...
router.put('/edit',async function(req,res){
    try {
        const sqlQuery='UPDATE admin_user SET name=?, email=?, password=?, designation=?, role=? WHERE id=?';
        const row=await pool.query(sqlQuery,req.params.id,[name,email,password,designation,role]);
...
module.exports= InviteAdminrouter;